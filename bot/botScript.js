...
if (greetingsRegex.test(input)) {
    ...
    responseMessage = "If you want to browse Beige items,&nbsp; <a href='http://localhost/beigegc/browse.php'>Click Here!</a>";
...
const botDefault = {
    ...
    avatar: 'bot/botphoto/Bill/avatar.png',
};
...
toggleButton.addEventListener('click', () => {
    ...
    initialMessage.classList.toggle('chat-display-visible', !chatContainer.classList.contains('minimized')); 
    toggleButton.style.backgroundColor = chatContainer.classList.contains('minimized') ? '#ffffcc' : '#ffffcc';
    toggleButton.innerHTML = chatContainer.classList.contains('minimized') ? '&#10133;' : '&#10134;';
});
